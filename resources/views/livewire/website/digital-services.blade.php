        ...
        @if($activeTab === 'downloads')
            <div>
                ...
                $ftColors = [
                    ...
                    'DOCX' => 'bg-[#002366]/10 text-[#002366]',
                    'XLS'  => 'bg-emerald-100 text-emerald-700',
                    'XLSX' => 'bg-emerald-100 text-emerald-700',
                ];
                $audColors = [
                    'Parents'  => 'bg-[#002366]/10 text-[#002366]',
                    'Students' => 'bg-[#B21F2D]/10 text-[#B21F2D]',
        ...
        @if($activeTab === 'calendar')
            ...
            <div class="flex flex-wrap items-center gap-3 mb-4">
                ...
                @if($allCalendarEntries->where('is_tentative', true)->isNotEmpty())
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-[#B21F2D]/5 border border-[#B21F2D]/20 text-[#B21F2D]">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div class="space-y-3" data-reveal="fade" style="--reveal-delay: 120ms">
                                    ...
                                    <div class="bg-white rounded-xl border border-slate-200 p-3 flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center gap-1.5 flex-wrap mb-0.5">
                                                ...
                                                @if($me->is_tentative)
                                                    <span class="text-[9px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded bg-[#B21F2D]/10 text-[#B21F2D]">{{ __('calendar_tentative_keyword') }}</span>
                                                @endif
                                            </div>
                                            @if($me->end_date)
                    ...
                    @if($allCalendarEntries->where('is_tentative', true)->isNotEmpty())
                        <div class="rounded-xl border border-[#B21F2D]/20 bg-[#B21F2D]/5 p-4">
                            <div class="flex items-center gap-2 mb-1.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#B21F2D] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/>
                                </svg>
                                <p class="text-sm font-bold text-[#B21F2D]">{{ __('calendar_tentative_heading') }}</p>
                            </div>
                            <p class="text-xs text-[#B21F2D] leading-relaxed">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-md transition-shadow"
                        ...
                        <div class="grid grid-cols-2 gap-3 pt-4 border-t border-slate-100">
                            <div class="flex items-center gap-2.5">
                                <div class="w-8 h-8 rounded-xl bg-[#002366]/5 flex items-center justify-center flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#002366]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/></svg>
                                </div>
                                <div>
                            ...
                            <div class="flex items-center gap-2.5">
                                <div class="w-8 h-8 rounded-xl bg-[#B21F2D]/5 flex items-center justify-center flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#B21F2D]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z"/></svg>
                                </div>
                                <div>
            ...
            @php
                $seriesColors = [
                    ['bg' => 'bg-[#002366]/5',     'border' => 'border-[#002366]/20',     'text' => 'text-[#002366]',     'badge' => 'bg-[#002366]/10 text-[#002366]'],
                    ['bg' => 'bg-[#B21F2D]/5',   'border' => 'border-[#B21F2D]/20',   'text' => 'text-[#B21F2D]',   'badge' => 'bg-[#B21F2D]/10 text-[#B21F2D]'],
