                            ...
                            @foreach($grouped as $section => $items)
                                <div class="px-3 pt-2 pb-1">
                                    ...
                                    @foreach($items as $item)
                                        <a href="{{ $item['url'] }}" wire:click="close" class="spotlight-item flex items-start gap-3 rounded-xl px-3 py-2.5 hover:bg-slate-50 focus:bg-slate-50 focus:outline-none transition-colors">
