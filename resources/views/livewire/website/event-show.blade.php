        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-5">
                    <p class="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4">{{ __('event_show_details_heading') }}</p>
                    <dl class="space-y-3">
                ...
                @if($event->contact)
                    <div class="bg-white rounded-2xl border border-slate-200 p-5">
                        <p class="text-xs font-bold uppercase tracking-widest text-slate-500 mb-3">{{ __('event_show_label_contact') }}</p>
