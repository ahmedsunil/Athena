<div class="rounded-xl border border-red-200 bg-white p-6 shadow-sm">
    <div class="mb-6">
        ...
        <p class="mt-1 admin-caption">Permanently delete your account and all associated data. This cannot be undone.</p>
    </div>

    @if(! $confirming)
        <button wire:click="confirmDeletion"
                class="rounded-lg bg-red-600 px-4 py-2 admin-button-label text-white shadow-sm hover:bg-red-700">
            Delete account
        </button>
    @else
        <div class="space-y-3">
