...
<div class="mx-auto space-y-4">
    <div>
        <h1 class="text-lg font-bold text-zinc-900 sm:text-xl">School Profile</h1>
        <p class="text-xs text-zinc-500 sm:text-sm">Manage the public school profile and contact details.</p>
    </div>
        ...
        <div class="grid gap-4 lg:grid-cols-3">
            <div class="space-y-4 lg:col-span-2">
                <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
                    <div class="mb-4">
                        <h2 class="text-sm font-semibold text-zinc-900">Basic Information</h2>
                        <p class="text-xs text-zinc-500">Core identity fields for the school.</p>
                    </div>
                ...
                <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
                    <div class="mb-4">
                        <h2 class="text-sm font-semibold text-zinc-900">Mission & Vision</h2>
                        <p class="text-xs text-zinc-500">Statements displayed on public school profile surfaces.</p>
                    </div>
                ...
                <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
                    <div class="mb-4">
                        <h2 class="text-sm font-semibold text-zinc-900">Contact Details</h2>
                        <p class="text-xs text-zinc-500">Public address, phone, and email information.</p>
                    </div>
            ...
            <div class="space-y-4">
                <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
                    <div class="mb-4">
                        <h2 class="text-sm font-semibold text-zinc-900">Brand Assets</h2>
                        <p class="text-xs text-zinc-500">Logo and hero image used by the API profile.</p>
                    </div>
                ...
                <div class="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
                    <button type="submit"
                            ...
                            class="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-zinc-950 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-zinc-800 disabled:opacity-60">
