<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('cms.about.leadership.create') }}" wire:navigate
            ...
            @forelse($members as $m)
                <tr>
                    ...
                    <td class="admin-table-cell whitespace-nowrap text-right">
                        <a href="{{ route('cms.about.leadership.edit', $m->id) }}" wire:navigate class="mr-2 text-xs font-medium text-zinc-500 hover:text-zinc-950">Edit</a>
            ...
            @foreach($members as $m)
                <li class="flex items-center gap-3 px-4 py-3">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('cms.about.leadership.edit', $m->id) }}" wire:navigate class="text-xs text-zinc-500">Edit</a>
