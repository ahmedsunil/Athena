<div class="mx-auto max-w-2xl space-y-4">
    ...
    <div>
        <h1 class="admin-page-title">{{ $leadershipId ? 'Edit Leadership Member' : 'New Leadership Member' }}</h1>
    </div>
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="flex items-center gap-2">
                <button type="submit"
                    ...
                    {{ $leadershipId ? 'Update' : 'Add member' }}
                </button>
                <a href="{{ route('cms.about.leadership') }}" wire:navigate
