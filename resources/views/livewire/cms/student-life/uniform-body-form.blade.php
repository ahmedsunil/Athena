<div class="mx-auto max-w-2xl space-y-4">
    ...
    <div>
        <h1 class="admin-page-title">{{ $bodyId ? 'Edit Uniform Body' : 'New Uniform Body' }}</h1>
    </div>
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="flex items-center gap-2">
                <button type="submit"
                    ...
                    {{ $bodyId ? 'Update uniform body' : 'Add uniform body' }}
                </button>
                <a href="{{ route('cms.uniform-bodies') }}" wire:navigate
