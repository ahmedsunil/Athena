    ...
    <div class="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm sm:p-5">
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" wire:model="name_en" placeholder="e.g. Science & Technology Club"
            ...
            <div>
                ...
                <input type="text" wire:model="meeting_schedule_en" placeholder="e.g. Thursdays, 2:30 – 4:00 PM"
                       class="h-9 w-full rounded-md border border-zinc-200 bg-white px-3 text-sm text-zinc-950 shadow-sm focus:border-zinc-950 focus:outline-none focus:ring-1 focus:ring-zinc-950">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" wire:model="patron_role_en" placeholder="e.g. Physics Teacher"
                           class="h-9 w-full rounded-md border border-zinc-200 bg-white px-3 text-sm text-zinc-950 shadow-sm focus:border-zinc-950 focus:outline-none focus:ring-1 focus:ring-zinc-950">
