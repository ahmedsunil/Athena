    ...
    <div class="rounded-xl border border-zinc-200 bg-white shadow-sm">
        <div class="flex items-start justify-between gap-4 border-b border-zinc-100 p-5">
            <div class="flex items-center gap-3">
                <div
                    class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-zinc-200 bg-white shadow-sm">
            ...
            <button type="button"
                ...
                <span
                    class="inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform duration-200 {{ $googleLoginEnabled ? 'translate-x-4' : 'translate-x-0' }}"></span>
            </button>
        </div>
