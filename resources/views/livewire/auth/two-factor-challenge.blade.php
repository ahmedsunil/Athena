<div>
    <h2 class="mb-2 text-base font-semibold text-zinc-950">Two-factor authentication</h2>
    ...
    <div class="space-y-4">
        ...
        @if(! $useRecovery)
            <div>
                <label class="mb-1.5 block text-xs font-medium text-zinc-700">Authentication code</label>
        ...
        @else
            <div>
                <label class="mb-1.5 block text-xs font-medium text-zinc-700">Recovery code</label>
                <input type="text" wire:model="recoveryCode"
                       autocomplete="one-time-code" autofocus
                       class="w-full rounded-lg border border-zinc-300 px-3 py-2 font-mono text-sm text-zinc-700 focus:border-zinc-950 focus:outline-none focus:ring-1 focus:ring-zinc-950">
        ...
        <button type="button" wire:click="$set('useRecovery', {{ $useRecovery ? 'false' : 'true' }})"
                class="w-full text-center text-xs font-medium text-zinc-950 hover:text-zinc-800">
