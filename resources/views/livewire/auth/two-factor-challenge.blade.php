    ...
    <div class="space-y-4">
        ...
        @if(! $useRecovery)
            <div>
                ...
                @error('code') <p class="mt-1 text-xs font-normal leading-5 text-red-600">{{ $message }}</p> @enderror
            </div>
        @else
            <div>
                ...
                @error('recoveryCode') <p class="mt-1 text-xs font-normal leading-5 text-red-600">{{ $message }}</p> @enderror
            </div>
        @endif
