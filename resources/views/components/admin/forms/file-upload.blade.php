...
<div class="space-y-3">
    ...
    <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-dashed border-zinc-300 p-4 admin-body-muted transition-colors hover:border-zinc-400 hover:text-zinc-700">
