...
<div
    ...
    <button @click="open = !open"
            class="rounded-lg p-1.5 text-zinc-500 transition-colors hover:bg-zinc-100">
    ...
    <div x-show="open"
         ...
         class="fixed inset-y-0 left-0 z-50 flex w-56 flex-col border-r border-zinc-200 bg-white shadow-xl"
         @click.stop>
