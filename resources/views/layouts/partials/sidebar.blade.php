    ...
    $navGroups = [
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'route'        => 'cms.apps',
                    'href'         => route('cms.apps'),
                    'activeRoutes' => ['cms.apps', 'cms.apps.create', 'cms.apps.edit'],
                ...
                [
                    'label'        => 'History',
                    'route'        => 'cms.history',
                    'href'         => route('cms.history'),
                    'activeRoutes' => ['cms.history', 'cms.history.create', 'cms.history.edit'],
                    'icon'         => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>',
                ],
                [
                    'label'        => 'Achievements',
                    'route'        => 'cms.achievements',
                    'href'         => route('cms.achievements'),
                    'activeRoutes' => ['cms.achievements', 'cms.achievements.create', 'cms.achievements.edit'],
                ...
                [
                    ...
                    'route'        => 'cms.team',
                    'href'         => route('cms.team'),
                    'activeRoutes' => ['cms.team', 'cms.team.create', 'cms.team.edit'],
        ...
        [
            ...
            'items' => [
                ...
                [
                    'label'        => 'Uniform Bodies',
                    'route'        => 'cms.uniform-bodies',
                    'href'         => route('cms.uniform-bodies'),
                    'activeRoutes' => ['cms.uniform-bodies'],
                ...
                [
                    'label'        => 'People',
                    'route'        => 'cms.people',
                    'href'         => route('cms.people'),
                    'activeRoutes' => ['cms.people'],
                    'icon'         => '<path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z"/>',
                ],
            ],
        ],
