    ...
    $navGroups = [
        ...
        [
            ...
            'items' => [
                ...
                [
                    'label' => 'Footer Links',
                    'route' => 'cms.footer-links',
                    'href'  => route('cms.footer-links'),
                ...
                [
                    ...
                    'route' => 'cms.contact-submissions',
                    'href'  => route('cms.contact-submissions'),
        ...
        [
            ...
            'items' => [
                [
                    'label' => 'Slides',
                    'route' => 'cms.home.slides',
                    'href'  => route('cms.home.slides'),
                ...
                [
                    'label' => 'Stats',
                    'route' => 'cms.home.stats',
                    'href'  => route('cms.home.stats'),
                ...
                [
                    'label' => 'Quick Access',
                    'route' => 'cms.home.quick-access',
                    'href'  => route('cms.home.quick-access'),
                ...
                [
                    'label' => 'Testimonials',
                    'route' => 'cms.home.testimonials',
                    'href'  => route('cms.home.testimonials'),
