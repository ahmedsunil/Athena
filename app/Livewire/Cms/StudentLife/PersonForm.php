...
class PersonForm extends Component
{
    ...
    {
        if ($personId) {
            $person = StudentLifePerson::findOrFail($personId);
    ...
    public function save(): void
    {
        ...
        if ($this->personId) {
            StudentLifePerson::findOrFail($this->personId)->update($data);
        ...
        $this->redirect(route('cms.people'), navigate: true);
    }
    ...
    {
        return view('livewire.cms.student-life.person-form', [
        ...
        ])->layout('layouts.app', ['title' => $this->personId ? 'Edit Person' : 'New Person']);
    }
}
